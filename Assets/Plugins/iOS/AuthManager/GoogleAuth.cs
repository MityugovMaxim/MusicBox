...
public static class GoogleAuth
{
	...
	static extern void GoogleAuthManager_Login(GoogleAuthSuccessCallback _Success, GoogleAuthFailedCallback _Failed);
	#endif
	...
	public static Task<(string IDToken, string AccessToken)> LoginAsync()
	{
		...
		#if UNITY_IOS && !UNITY_EDITOR
		GoogleAuthManager_Login(InvokeLoginSuccess, InvokeLoginFailed);
		#else
