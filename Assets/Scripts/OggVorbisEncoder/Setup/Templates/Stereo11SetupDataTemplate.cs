...
{
	public class Stereo11SetupDataTemplate : ISetupTemplate
	{
		public int      Mappings                 => SampleRateMapping.Length - 1;
		public double[] SampleRateMapping        => Psy11.RateMapCoupled;
		...
		public IMappingTemplate[] Maps => Residue8.MapResCoupled;
	}
}