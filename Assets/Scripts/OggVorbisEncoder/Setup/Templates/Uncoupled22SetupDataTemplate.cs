...
{
	internal class Uncoupled22SetupDataTemplate : ISetupTemplate
	{
		public int      Mappings                 => SampleRateMapping.Length - 1;
		public double[] SampleRateMapping        => Psy22.RateMapUncoupled;
		public double[] QualityMapping           => Psy16.QualityMapping;
		public int      CouplingRestriction      => -1;
		public int      SampleRateMinRestriction => 19000;
		public int      SampleRateMaxRestriction => 26000;
		...
		public double[] PsyLowPass => Psy22.Lowpass;
		...
		public IMappingTemplate[] Maps => Residue16.MapResUncoupled;
	}
}