...
class Psy16
{
    ...
    internal static readonly double[] RateMapCoupled = { 12000.0, 20000.0, 44000.0, 86000.0 };
    internal static readonly double[] RateMapUncoupled = { 16000.0, 28000.0, 64000.0, 100000.0 };
