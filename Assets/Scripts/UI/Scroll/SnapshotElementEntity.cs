...
public class SnapshotElementEntity : LayoutEntity
{
	...
	public SnapshotElementEntity(string _Path, Snapshot _Snapshot, Action<Snapshot> _Remove, UISnapshotElement.Pool _Pool)
	{
		m_Path     = _Path;
	...
	public override void Create(RectTransform _Container)
	{
		...
		m_Item.Setup(m_Path, m_Snapshot, m_Remove);
	}
