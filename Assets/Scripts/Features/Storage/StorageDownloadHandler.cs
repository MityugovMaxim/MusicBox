...
public class StorageDownloadHandler : IProgress<DownloadState>, IDisposable
{
	...
	public StorageDownloadHandler(Task<bool> _Task, Action<float> _Progress)
	{
		Task       = _Task;
	...
	public void Report(DownloadState _State)
	{
		if (m_Progress == null)
			return;
